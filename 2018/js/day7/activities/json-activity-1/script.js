...
var videos = [
  ...
  {
    "youtubeId":"-N-FiLtb744",
		"title":"Top of the World",
		"author":"Untitled Offroad"
	}
];
...
var addVideoToList = function(video) {
	...
	var videoAuthor = document.createTextNode(video.author); //Create a text node with the video author
	...
	videoLink.appendChild(videoAuthor); //Append the video Author to the link
	...
	videoLink.addEventListener('click', function(e){
		...
		videoEmbed.width = 1524; //Set the width of the video iframe
		videoEmbed.height = 768; //Set the height of the video iframe
