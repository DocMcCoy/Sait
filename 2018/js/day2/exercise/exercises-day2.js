...
function sumOfArray (holder) {
    ...
    console.log("Here is the input array only adding the numbers less than or equal to 5;\n" + holder);
    console.log("The sum of the input array is equal to;\n" + sum);
}
...
console.log("Here are the properties for rect;");
console.log(rect);
...
console.log("Height changed in the object to be the square root of the width;");
console.log(rect);

//8. console.log the rectangle's area (width * height). Use *dot notation* to access the properties!

console.log(rect.width * rect.height + " squared units");
